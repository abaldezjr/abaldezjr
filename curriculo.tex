...
\begin{document}
    ...
    \begin{itemize}
        ...
        \item Técnico Sistemas para Internet e Intranet - Instituto Federal de Educação, Ciência e Tecnologia do Rio grande do sul (IFRS) - 2009
    \end{itemize}
    ...
    \begin{itemize}
        ...
        \item Currículo Impressão - https://abaldezjr.github.io/abaldezjr/curriculo-impressao.html
    \end{itemize}
\end{document}